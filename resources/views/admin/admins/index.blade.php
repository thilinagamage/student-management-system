                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <form class="ms-auto position-relative" method="GET">
                                ...
                                <input class="form-control ps-5" type="text" name="search" placeholder="Search admin..."
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                                    <a href="{{ route('admin.admins.view', $admin->id) }}" class="text-primary" data-bs-toggle="tooltip"
