            ...
            <div class="col-12 col-lg-8">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.batches.update', $batch->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="card shadow-none border mb-3">
                                ...
                                <div class="card-body row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="description" class="form-control" rows="3">{{ old('description', $batch->description) }}</textarea>
                                    </div>
                            ...
                            <div class="text-start">
                                ...
                                <a href="{{ route('admin.batches.index') }}" class="btn btn-secondary px-4 ms-2">
                                    Back
                                </a>
                            </div>
