        ...
        <div class="col-12 col-lg-6">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.course-types.update', $courseType->id) }}"
                          method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   name="type_name"
                                   class="form-control"
                                   value="{{ old('type_name', $courseType->type_name) }}"
                                   required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description"
                                      class="form-control"
                                      rows="3">{{ old('description', $courseType->description) }}</textarea>
                        </div>
