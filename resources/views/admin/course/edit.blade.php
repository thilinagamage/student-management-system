            ...
            <div class="col-12 col-lg-8">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('admin.courses.update', $course->id) }}" method="POST">
                            @csrf
                                ...
                                <div class="card-body row g-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="duration_type" class="form-select">
                                            ...
                                            <option value="weeks"
                                                {{ $course->duration_type == 'weeks' ? 'selected' : '' }}>Weeks</option>
                                            <option value="months"
                                                {{ $course->duration_type == 'months' ? 'selected' : '' }}>Months</option>
                                            <option value="years"
                                                {{ $course->duration_type == 'years' ? 'selected' : '' }}>Years</option>
                                        </select>
                                    </div>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.courses.view', $course->id) }}" class="btn btn-secondary">
                                    Cancel
                                </a>
                            </div>
