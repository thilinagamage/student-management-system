            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.student-attendance.create') }}" class="btn btn-sm btn-success">
                            + Mark Attendance
                        </a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-info text-dark">
                                                    {{ $attendance->attendanceBatch->batch_code }}
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="badge bg-{{ $statusColors[$attendance->status] ?? 'primary' }}">
                                            ...
                                            <td>
                                                <a href="{{ route('admin.student-attendance.edit', [$attendance->batch_id, $attendance->attendance_date]) }}"
                                                    class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    title="Edit"><i class="bi bi-pencil-fill"></i></a>
                                                <a href="{{ route('admin.student-attendance.delete', [$attendance->batch_id, $attendance->attendance_date]) }}"
