            ...
            <div class="col-12">
                ...
                <div class="card shadow-sm">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin.student-enrollment.create') }}" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    @forelse($enrollments as $index => $student)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ optional($student->batches->first()?->pivot)->created_at?->format('d M Y') ?? '-' }}
                                            </td>

                                            <td class="text-center">
                                                <a href="{{ route('admin.student-enrollment.edit', $student->id) }}"
                                                    class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    title="Edit"><i class="bi bi-pencil-fill"></i></a>
                                                <a href="{{ route('admin.student-enrollment.delete', $student->id) }}"
