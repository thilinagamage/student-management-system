    ...
    <main class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.teacher-attendance.update', $attendance->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" disabled>
                                <option>{{ $attendance->teacher->first_name }} {{ $attendance->teacher->last_name }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="status" class="form-select" required>
                                ...
                                <option value="cancelled" {{ $attendance->status == 'cancelled' ? 'selected' : '' }}>
                                    Cancelled</option>
                            </select>
                        </div>
